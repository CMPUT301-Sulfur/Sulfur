...
public class OrganizerEventsAdapter extends RecyclerView.Adapter<OrganizerEventsAdapter.MyViewHolder> {
    ...
    @NonNull
    @Override
    public OrganizerEventsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // This is where you inflate the layout (giving a look to our rows)

        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.organizer_events_row, parent, false);
        return new OrganizerEventsAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull OrganizerEventsAdapter.MyViewHolder holder, int position) {
